  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#09090f', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="flex flex-col justify-center w-full lg:w-1/2 px-8 sm:px-16 py-12 relative">
        ...
        {/* Heading */}
        <div className="mb-8">
          <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 'clamp(2rem, 4vw, 2.75rem)', lineHeight: 1.15, color: '#f0f0fa', marginBottom: '0.75rem' }}>
            Welcome back!
          </h1>
        ...
        >
          ...
          <div>
            <div className="flex justify-between items-center" style={{ marginBottom: '6px' }}>
              ...
              <button type="button" style={{ fontSize: '0.8125rem', color: '#7c6af7', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>
                Forgot password?
              </button>
            </div>
            <input
